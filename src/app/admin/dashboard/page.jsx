...
export default function DashboardPage() {
  ...
  // Navigate to pages
  const navigateToProducts = () => router.push(`${process.env.NEXT_PUBLIC_FRONTEND_URL}/admin/products`);
  const navigateToCategories = () => router.push(`${process.env.NEXT_PUBLIC_FRONTEND_URL}/admin/categories`);
  const navigateToSizes = () => router.push(`${process.env.NEXT_PUBLIC_FRONTEND_URL}/admin/sizes`);
