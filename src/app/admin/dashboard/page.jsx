...
export default function DashboardPage() {
  ...
  // Navigate to products/categories pages
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Overview of your inventory and product management
          </p>
        </div>
                  ...
                  <div className="space-y-4">
                    {inventorySummary.inventoryByCategory.map((item) => (
                      <div key={item.category.id} className="flex items-center">
                        <div className="w-36 truncate">{item.category.name}</div>
                        ...
                        <div className="w-12 text-right font-medium">{item.totalInventory}</div>
                      </div>
                    ))}
                  </div>
                ) : (
                ...
                {inventorySummary.inventoryBySize && inventorySummary.inventoryBySize.length > 0 ? (
                  <div className="space-y-4">
                    {inventorySummary.inventoryBySize.map((item) => (
                      <div key={item.size.id} className="flex items-center">
